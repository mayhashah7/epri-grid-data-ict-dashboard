# ict-schematic-knowledge-retrieval

**Domain:** Grid ICT, Data & Cybersecurity → schematics

**Mission:** Semantic search across one-line drawings & schemes

## Background
OCR + symbol recognition over schematic diagrams, one-lines, protection schemes. Enables semantic queries across legacy drawings.
