# ict-knowledge-graph-asset

**Domain:** Grid ICT, Data & Cybersecurity → kg

**Mission:** Unified knowledge graph: assets ↔ events ↔ work-orders

## Background
Builds a cross-system KG linking traffic, security alerts, system logs, asset records, and work orders. Enables multi-hop investigations.
