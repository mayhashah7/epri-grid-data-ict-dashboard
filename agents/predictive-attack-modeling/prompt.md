# ict-predictive-attack-modeling

**Domain:** Grid ICT, Data & Cybersecurity → attack

**Mission:** Likely next-step prediction in attack kill-chain

## Background
Models adversary behavior across MITRE ATT&CK ICS to predict next-likely steps and recommend pre-emptive containment.
